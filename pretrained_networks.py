...
gdrive_urls = {
    ...
    'gdrive:networks/stylegan2-ffhq-config-f.pkl': './models/stylegan2-ffhq-config-f.pkl'                         #'http://d36zk2xti64re0.cloudfront.net/stylegan2/networks/stylegan2-ffhq-config-f.pkl',
